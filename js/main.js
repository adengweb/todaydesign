...
$('.j-wechat').on('click', function() {
  $('.j-wechat-pop').removeClass('g-hide');
});
$('.j-wechat-pop').on('click', function() {
  $(this).addClass('g-hide');
});

// map
$('.j-map').on('click', function() {
  $('.j-map-pop').removeClass('g-hide');
});
$('.j-map-pop').on('click', function() {
  $(this).addClass('g-hide');
});
...
$(".lazyload img").lazyload({ placeholder : "img/imglazy.jpg",effect: "fadeIn" });